    ...
    modal.innerHTML = `
        <div class="modal-container">
            ...
            <div class="modal-body">
                ${noticia.imagen ? `<img src="${noticia.imagen}" alt="${noticia.titulo}">` : '<div class="bg-beige h-48 rounded-2xl flex items-center justify-center"><span class="material-icons text-marronClaro text-5xl">newspaper</span></div>'}
